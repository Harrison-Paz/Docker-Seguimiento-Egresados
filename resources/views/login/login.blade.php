...
<head>
    ...
    <!--[if lt IE 10]>
      ...
      <!--notificaton.css-->
     <link rel="stylesheet" type="text/css" href="{{asset('assets/pages/notificaton/notificaton.css')}}">
     <!-- Animate.css -->
                            ...
                            <div class="auth-box card">
                                <div class="card-block">
                                    ...
                                    <div class="form-group form-primary">
                                        <input type="email" required name="email" autofocus value="{{ old('email') }}" class="form-control">
